...
Ext.extend(Ext.ux.calendar.CalendarContainer, Ext.Panel, {
    ...
    onAboutMyCalendarFn : function(){
        ...
        '    <span style="font-size:16px;"><b>理想软件教育</b></span><br/>' +
        '    <font color="grey">版本号1.0</font>' +
        '    <br/><br/>' +
        '    Copyright &copy; 2007-2011 Lxitedut Inc. All right reserved<br/>' +
        '    <a href="http://www.lxitedu.com" target="_blank">http://www.lxitedu.com</a><br/><br/>' +
        '</div>' +
        '<div style="clear:left;padding:0 20px 20px;">' +
        '    查询更多的版权信息请访问理想官方网站或者' +
        '    发送Email到: <a href="mailto:info@feyasoft.com">lxitedut@sina.com</a>.' +
        '    <br><br><hr>' +
        '    警告: 此日历系统受法律保护和国际约束，未授权请不要以任何形式发布或者开源此系统，不得以用于任何商业用户。如果需要购买此产品，请发送邮件到lxitedu@sina.com' +
        '    第一次使用必须支付500$版权费用，我们将提供技术和业务支持！'+
        '</div>';
