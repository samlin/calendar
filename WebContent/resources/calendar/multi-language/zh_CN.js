...
Ext.ux.calendar.Language = {
    ...
    'Editor':{
        ...
        'intervalUnitLabel.day.text':' 日(s) ',
        'intervalUnitLabel.week.text':' 周(s) ',
        'intervalUnitLabel.month.text':' 月(s) ',
        'intervalUnitLabel.year.text':' 年(s) ',
        'detailSetting':'详细输入...',
        'returnBtn.text':'退后',
    ...
    'SettingPopup':{
        ...
        'dwViewForm.title':'日-周视图',
        'monthViewForm.title':'月视图',
        'createByDblClickField.label':'双击创建一个事件',
        'singleDayField.label':'交叉日',
        'weekStartDayField.label': '开始的星期天',
        'activeStartTimeField.label':'活动开始时间',
        'activeEndTimeField.label':'活动结束时间',
        'hideInactiveTimeField.label':'隐藏不活动的时间',
        'readOnlyField.label':'只读',
        'intervalField.label':'时间间隔',
